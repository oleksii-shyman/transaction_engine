...
2. Can available funds be negative when processing disputes.
    Let's say that:
        1. a client Deposits 100
        2. a client Withdraws 50
        3. a client Disputes the deposit of 100
    Answer -> Yes, available funds can be negative when processing disputes.
